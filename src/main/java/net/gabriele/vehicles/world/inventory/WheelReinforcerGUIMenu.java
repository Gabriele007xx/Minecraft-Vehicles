...
package net.gabriele.vehicles.world.inventory;
...
public class WheelReinforcerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WheelReinforcerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(VehiclesModMenus.WHEEL_REINFORCER_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 5, 53) {
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 134, 34) {
