...
package net.gabriele.vehicles.entity;
...
public class CartEntity extends PathfinderMob implements GeoEntity {
	...
	public CartEntity(EntityType<CartEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.skeleton_horse.ambient"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.horse.step")), 0.15f, 1);
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("entity.zombie.attack_wooden_door"));
	}
			...
			if (sourceentity instanceof ServerPlayer serverPlayer) {
				serverPlayer.openMenu(new MenuProvider() {
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						...
						packetBuffer.writeVarInt(CartEntity.this.getId());
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(CartEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
